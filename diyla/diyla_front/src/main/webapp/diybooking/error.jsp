...
<body><!-- header-area-end --><!-- main-area -->
<main><!-- breadcrumb-area -->
    ...
    </section><!-- breadcrumb-area-end --><!-- 404-area -->
                ...
                <div class="col-lg-6 col-md-10">
                    <div class="error-content text-center">
                        ...
                        <div class="search_form">
                            <form method="post"><input name="text" id="text" type="text" placeholder="Search"
                                                       class="form-control"><button type="submit" class="icon_search"><i
                                    class="flaticon-loupe"></i></button></form>
                        </div><a href="index.html" class="btn btn-fill-out">Back To Home</a>
                    </div>
                </div>
            </div>
        </div>
